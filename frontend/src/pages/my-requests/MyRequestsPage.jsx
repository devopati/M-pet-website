...
const MyRequestsPage = () => {
  return <div className="ml-[60px]">
   <div>
   <h1 className=" mt-4 text-[25px]  font-semibold ">Request about different breeds</h1>
   </div>
   <div>
    <form action="">
    ...
    <label htmlFor="dog">Dog
      ...
      <label htmlFor="other">Other 
        <input required type="radio" id="other" name="other" value='other'  />
      </label>
    </div>
     ...
     <label className="">Type of breed
        <input className=" border-gray-400 text-sm h-3 ml-5 focus:bg-none outline-none" type="text" placeholder="Dog/cat breed" />
      </label>
     </div>
      <div className=" flex items-center mt-4">
        Description
      
        <textarea className=" border-gray-400 text-sm ml-5" placeholder="Describe the breed here...." name=""></textarea>
